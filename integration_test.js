...
(async () => {
  ...
  page.on('request', async request => {
    ...
    if(request.url().toString().includes('hb.emxdgt.com')){
        ...
        console.error(JSON.stringify(hbRequest));
